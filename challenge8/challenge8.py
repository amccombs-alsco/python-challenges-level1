import requests
import unittest
from Framework.Search import Searches as s
from Framework.Access import AccessCreds as a


class Challenge8(unittest.TestCase):
    def setUp(self):
        self.web = 'https://www.copart.com/public/lots/search'
        self.url = "https://www.copart.com/public/data/reCaptcha/secretKey"
        self. payload = {'Authorization': 'Basicbase64(user:password)'}
