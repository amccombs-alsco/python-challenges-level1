...
class GrabData:
    ...
    def count_damage(self):
        ...
        # for operator in self.find_damages():
        #     switcher = {
        #         'REAR END': [].append(str(operator)),
        #         'FRONT END': [].append(str(operator)),
        #         'MINOR DENT/SCRATCHES': [].append(str(operator)),
        #         'UNDERCARRIAGE': [].append(str(operator))
        #     }
        #     switcher.get(operator, 'Misc')
        #     count = switcher['REAR END'], Counter([])
        #     print(count)
